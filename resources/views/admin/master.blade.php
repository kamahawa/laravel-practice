...
<head>
    ...
    <meta name="description" content="Học Lập Trình Laravel Framework 5.x">
    <meta name="author" content="Kama Hawa">
    <title>Admin - Kama Hawa</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Area - Kama Hawa</a>
            </div>
            <!-- /.navbar-header -->
                ...
                @else
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            {!! Auth::user() ? Auth::user()->username : "" !!} <i class="fa fa-user fa-fw"></i>  <i class="fa fa-caret-down"></i>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <!--<li><a href="#"><i class="fa fa-user fa-fw"></i> {!! Auth::user() ? Auth::user()->username : "" !!}</a></li>-->

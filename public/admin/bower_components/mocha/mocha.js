...
// With node.js on Windows: use symbols available in terminal default fonts
	...
	require.register("reporters/progress.js", function (module, exports, require) {
		...
		function Progress(runner, options) {
			...
			var self = this, options = options || {}, stats = this.stats, width = Base.window.width * .50 | 0, total = runner.total, complete = 0, max = Math.max;
	...
	require.register("reporters/xunit.js", function (module, exports, require) {
		...
		function test(test) {
			var attrs = {
				classname: test.parent.fullTitle(), name: test.title, time: (test.duration / 1000) || 0
			};
	...
	require.register("runner.js", function (module, exports, require) {
		...
		var EventEmitter = require('browser/events').EventEmitter, debug = require('browser/debug')('mocha:runner'), Test = require('./test'), utils = require('./utils'), filter = utils.filter, keys = utils.keys;
	...
	require.register("utils.js", function (module, exports, require) {
		...
		exports.keys = Object.keys || function (obj) {
			var keys = [], has = Object.prototype.hasOwnProperty // for `window` on <=IE8
